...
Ridge shows strong overall calibration. At low predicted probabilities it tends to overestimate & between \~0.5 & 0.75 it underestimates. At higher probabilities, ridge shows almost perfect calibration.
...
::: smallest
-   Across all models, EPV alone did not explain predictive performance
-   Ridge & Random Forest often outperformed MLE at low EPV, but performance improved with larger N, correlated predictors & stronger effects
-   Our Monte Carlo results reinforce that the three models differed in accuracy and stability, but their performance patterns were driven by the same factors: **sample size, predictor correlation & effect structure—not just EPV**.
:::
