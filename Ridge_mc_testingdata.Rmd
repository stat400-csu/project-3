...
ridge_results_testing_df <- bind_rows(ridge_results)
head(ridge_results_testing_df)
...
ridge_condition_summary <- ridge_results_testing_df |>
...
```{r}
# saving the monte carlo simulation results for comparisons

if (!dir.exists("results_files")) dir.create("results_files")
#saveRDS(ridge_results_df, file = "results_files/ridge_mc_results.rds")
write.csv(ridge_results_testing_df, file = "results_files/ridge_mc_testing_results.csv", row.names = FALSE)
```
